...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'chronos_reference', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chronos.Project']))

    def backwards(self, orm):

        # Changing field 'Reference.project'
        db.alter_column(u'chronos_reference', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['chronos.Project']))
