...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chronos_reference', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reference_created_by', to=orm['auth.User'])),
            ('edited_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reference_edited_by', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'chronos', ['Reference'])

        # Deleting field 'Task.project'
        db.delete_column(u'chronos_task', 'project_id')

        # Deleting field 'Task.nameasd'
        db.delete_column(u'chronos_task', 'nameasd')


    def backwards(self, orm):
        # Deleting model 'Reference'
        db.delete_table(u'chronos_reference')

        # Adding field 'Task.project'
        db.add_column(u'chronos_task', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='project_id', to=orm['chronos.Project']),
                      keep_default=False)

        # Adding field 'Task.nameasd'
        db.add_column(u'chronos_task', 'nameasd',
