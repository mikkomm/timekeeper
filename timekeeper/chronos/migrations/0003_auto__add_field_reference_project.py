...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'chronos_reference', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='reference_project', to=orm['chronos.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference.project'
        db.delete_column(u'chronos_reference', 'project_id')
    ...
    models = {
        ...
        u'chronos.reference': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reference_project'", 'to': u"orm['chronos.Project']"})
        },
        u'chronos.task': {
